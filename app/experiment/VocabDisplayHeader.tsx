...
const VocalDisplayHeader = ({currentTab, setCurrentTab, toggleModal}: SettingsProps) => {
      ...
      <div className="flex items-center justify-between">
        <div className="flex">
          <div
            ...
            className={`cursor-pointer py-1 xs:px-7 px-5 border-t border-l rounded-tl-md rounded-tr-md 
...
export default VocalDisplayHeader;
